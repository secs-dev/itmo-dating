...
export const RegistrationPictures = (registrationPicturesProps: RegistrationPicturesProps) => {
        ...
        <Section header="Your photos" style={{}}>
            <div style={{
                ...
                {uploadedFiles.map(uploadedFile => (
                    <RegistrationPictureElement key={uploadedFile.id} id={uploadedFile.id}
                                                src={uploadedFile.src} onDeleteButtonClick={
                        (id: number) => deletePicture({uploadedFiles, setUploadedFiles}, id)
                    }/>
                ))}
                <AddPictureButton handleUploadingPhotos={
                    e => {
