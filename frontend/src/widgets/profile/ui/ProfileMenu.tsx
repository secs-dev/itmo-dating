            ...
            {editButtonClicked ?
                ...
                (<>
                        <div style={{marginBottom: "5%"}}>
                            <Button before={<Icon28Edit/>} mode={"bezeled"} onClick={() => setEditButtonClicked(true)}>
                        ...
                        <Card type="plain" style={{
                            ...
                            >
                                <div
                                    style={{textWrap: "pretty"}}>{actualPerson?.firstName} {actualPerson?.lastName}</div>
                                <div style={{textWrap: "pretty"}}>height: {actualPerson?.height}</div>
                                <div
                                    style={{textWrap: "pretty"}}>location: {JSON.stringify(actualPerson?.location)}</div>
                                <div style={{textWrap: "pretty"}}>faculty: {actualPerson?.faculty}</div>
                                <div
                                    style={{textWrap: "pretty"}}>birthday: {actualPerson?.birthday.toDateString()}</div>
                                <div
                                    style={{textWrap: "pretty"}}>lastUpdate: {actualPerson?.updateMoment.toString()}</div>
