...
export const SwiperMenu = () => {
    ...
    return (
        <Section header={'Recommendations'} style={{display: 'block', height: '50%', paddingBottom: '20%'}}>
            <Card type='plain' style={{
                background: 'var(--tgui--secondary_bg_color)',
                width: '100%'
            }}>
                <CardChip readOnly onClick={_ => {
                ...
                <CardCell
                    readOnly
                    style={{color: 'var(--tgui--text_color)', display: 'block', textWrap: 'pretty', backgroundColor: 'var(--tgui--bg_color)'}}
                >
                    <div style={{textWrap: 'pretty'}}>{actualPerson.firstName} {actualPerson.lastName}</div>
                    <div style={{textWrap: 'pretty'}}>height: {actualPerson.height}</div>
                    <div style={{textWrap: 'pretty'}}>location: {JSON.stringify(actualPerson.location)}</div>
                    <div style={{textWrap: 'pretty'}}>faculty: {actualPerson.faculty}</div>
                    <div style={{textWrap: 'pretty'}}>birthday: {actualPerson.birthday.toDateString()}</div>
                    <div style={{textWrap: 'pretty'}}>lastUpdate: {actualPerson.updateMoment.toString()}</div>
